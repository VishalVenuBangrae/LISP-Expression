...
_lr_productions = [
  ...
  ('start -> list SEMI','start',2,'p_start_1','LispParser.py',6),
  ('start -> num SEMI','start',2,'p_start_2','LispParser.py',11),
  ('num -> NUMBER','num',1,'p_num_1','LispParser.py',16),
  ('num -> VAR','num',1,'p_num_2','LispParser.py',21),
  ('num -> LPAREN OP num num RPAREN','num',5,'p_num_3','LispParser.py',26),
  ('num -> LPAREN CAR list RPAREN','num',4,'p_num_4','LispParser.py',31),
  ('num -> LPAREN LET LPAREN vars RPAREN num RPAREN','num',7,'p_num_5','LispParser.py',36),
  ('list -> LPAREN seq RPAREN','list',3,'p_list_1','LispParser.py',41),
  ('list -> LPAREN CDR list RPAREN','list',4,'p_list_2','LispParser.py',46),
  ('list -> LPAREN CONS num list RPAREN','list',5,'p_list_3','LispParser.py',51),
  ('seq -> <empty>','seq',0,'p_seq_1','LispParser.py',56),
  ('seq -> num seq','seq',2,'p_seq_2','LispParser.py',61),
  ('vars -> LPAREN VAR num RPAREN','vars',4,'p_vars_1','LispParser.py',66),
  ('vars -> vars LPAREN VAR num RPAREN','vars',5,'p_vars_2','LispParser.py',71),
]
